 ...
 */
final class Version20260111005515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cards CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE user_id user_id INT NOT NULL, CHANGE card_number card_number VARCHAR(16) NOT NULL, CHANGE valid_until valid_until VARCHAR(5) NOT NULL, CHANGE cvc_code cvc_code INT NOT NULL, CHANGE country country VARCHAR(255) NOT NULL');
    }
